...
if [ $n_missing -gt 0 ]; then
  ...
  echo "  Download from Zenodo (DOI 10.5281/zenodo.20635986):"
  echo "    https://zenodo.org/records/20635986"
  echo "    per file:  wget https://zenodo.org/records/20635986/files/<ptbank_name>"
